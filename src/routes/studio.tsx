...
function tokensToStyle(t: DirTokens): CSSProperties {
  const vars: Record<string, string> = {
    "--s-bg": t.bg,
    "--s-card": t.card,
    "--s-card-elev": t.cardElev,
    "--s-text": t.text,
    "--s-muted": t.textMuted,
    "--s-subtle": t.textSubtle,
    "--s-border": t.border,
    "--s-border-strong": t.borderStrong,
    "--s-primary": t.primary,
    "--s-primary-fg": t.primaryFg,
    "--s-primary-soft": t.primarySoft,
    "--s-ai": t.ai,
    "--s-ai-soft": t.aiSoft,
    "--s-success": t.success,
    "--s-warning": t.warning,
    ...
    "--s-planned": t.planned,
    "--s-sidebar": t.sidebar,
    "--s-sidebar-active": t.sidebarActive,
    "--s-input": t.input,
    "--s-tablehead": t.tableHead,
    "--s-row-hover": t.rowHover,
    "--s-shadow-card": t.shadowCard,
    "--s-shadow-elev": t.shadowElev,
    "--s-radius": t.radius,
  };
  return {
