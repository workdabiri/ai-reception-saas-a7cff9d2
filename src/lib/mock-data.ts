...
export const customers: Customer[] = [
  ...
  },
  {
    id: "c2",
    name: "Jonas Reuter",
    email: "j.reuter@hey.com",
    phone: "+49 30 5550 8821",
    tags: ["New"],
    lastSeen: "1 hr ago",
    conversations: 1,
    initials: "JR",
    primaryChannel: "webform",
    lastInboundChannel: "webform",
    openConversations: 1,
    unreadMessages: 1,
    needsFollowUp: false,
  },
  {
    id: "c3",
    name: "Naomi Tanaka",
    email: "naomi.t@outlook.com",
    phone: "+81 90 5550 1133",
    tags: ["Returning"],
    lastSeen: "3 hr ago",
    conversations: 4,
    initials: "NT",
    ...
    messages: [
      {
        ...
        time: "Today · 10:42",
        body: "Hi — could we move my Thursday 3pm cleaning to next week if possible? Something came up at work.",
      },
      {
        id: "m2",
        author: "system-classification",
        authorName: "System",
        time: "Today · 10:42",
        body: "Classified as Scheduling · priority High",
      },
      {
        id: "m3",
      ...
      },
      {
        ...
        authorName: "AI draft",
        time: "Today · 10:43",
        body: "Hi Eleanor, of course — we have openings next Tuesday at 2:00pm or Wednesday at 10:30am. Which works best? — Tehran Dental Clinic",
      },
      {
        id: "m5",
        ...
        time: "Today · 10:46",
        body: "She prefers mornings. I'll suggest Wed 10:30am first and hold Tue 2pm as backup.",
      },
    ],
  },
  {
    ...
    messages: [
      {
        ...
        time: "Today · 10:12",
        body: "Hello, I'm new to the area and wondering if you accept Aetna and what a first cleaning would cost.",
      },
      {
        id: "m2",
        author: "system-classification",
        authorName: "System",
        time: "Today · 10:12",
        body: "Classified as Billing · priority Normal",
      },
      {
        id: "m3",
        author: "system-assignment",
    ...
    messages: [
      {
        id: "m1",
        author: "customer",
        authorName: "Naomi Tanaka",
        time: "Today · 08:55",
        body: "Got my invoice — I think the fluoride was charged twice. Could someone double check?",
      },
      {
        id: "m2",
        author: "system-classification",
        authorName: "System",
        time: "Today · 08:55",
        body: "Classified as Billing dispute · priority Urgent",
      },
      {
        id: "m3",
        author: "operator",
        authorName: "Priya R.",
        time: "Today · 09:14",
        body: "Hi Naomi — checking with billing now and will get back today.",
      },
      {
        id: "m4",
        ...
        authorName: "System",
        time: "Today · 09:14",
        body: "Status changed to Waiting on internal review",
      },
      {
        id: "m5",
        author: "internal-note",
        authorName: "Priya Raman",
        time: "Today · 09:18",
        body: "Pinged Daniel to pull the ledger entry. Likely a duplicate from the rebooking last week.",
      },
    ],
  },
  {
    ...
    messages: [
      {
        ...
        body: "What's the price range for whitening? Also do you offer payment plans?",
      },
      {
        id: "m2",
        author: "system-classification",
        authorName: "System",
        time: "Yesterday · 16:20",
        body: "Classified as Sales · priority Normal",
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: "m1",
        author: "customer",
        authorName: "Hannah Berg",
        time: "Mon · 14:02",
        body: "Just wanted to say Dr. Park was wonderful with my son today. Thank you!",
      },
      {
        id: "m2",
        author: "operator",
        authorName: "Daniel C.",
        time: "Mon · 14:18",
        body: "Hannah, this made our day — passing along to Dr. Park. ❤️",
      },
      {
        id: "m3",
        author: "system-status",
        authorName: "System",
        time: "Mon · 14:19",
        body: "Conversation closed by Daniel Cho",
      },
    ],
  },
  {
    ...
    messages: [
      {
        ...
        time: "Wed · 09:30",
        body: "Where do I find the new patient forms?",
      },
    ],
  },
];
...
export const recentMessages: RecentMessage[] = [
  {
    ...
    customer: "Eleanor Whitfield",
    initials: "EW",
    snippet: "Could we move my Thursday 3pm cleaning to next week?",
    channel: "email",
    time: "12 min",
  },
  {
    ...
    customer: "Jonas Reuter",
    initials: "JR",
    snippet: "Do you accept Aetna and what does a first cleaning cost?",
    channel: "webform",
    time: "38 min",
  },
  {
    ...
    customer: "Naomi Tanaka",
    initials: "NT",
    snippet: "I think the fluoride was charged twice on my invoice.",
    channel: "email",
    time: "2 hr",
  },
  {
    ...
    customer: "Carlos Mendes",
    initials: "CM",
    snippet: "What's the price range for whitening? Payment plans?",
    channel: "webform",
    time: "Yesterday",
  },
];
...
export const draftQueue: DraftReview[] = [
  {
    ...
    subject: "Reschedule Thursday cleaning",
    draft:
      "Hi Eleanor, of course — we have openings next Tuesday at 2:00pm or Wednesday at 10:30am…",
    confidence: "High",
    prepared: "1 min ago",
  },
  {
    ...
    customer: "Jonas Reuter",
    initials: "JR",
    subject: "New patient — insurance",
    draft:
      "Hi Jonas, welcome! Yes, we accept Aetna PPO. A first cleaning typically runs $120–$160…",
    confidence: "Medium",
    prepared: "5 min ago",
  },
  {
    ...
    initials: "CM",
    subject: "Whitening consultation",
    draft: "Hi Carlos, professional whitening starts at $290. We also offer 3-month payment plans…",
    confidence: "Medium",
    prepared: "22 min ago",
  },
];
...
export const auditEvents: AuditEvent[] = [
  ...
  },
  {
    ...
    result: "Denied",
    details:
      "Server-side membership check rejected the request. Client-side hint was a UX safeguard only.",
  ...
  },
  {
    ...
    result: "Failed",
    details:
      "Export request referenced a workspace the actor is not a member of. Request rejected before any data was read.",
