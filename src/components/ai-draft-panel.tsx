...
export function AIDraftPanel({
  ...
  return (
    <div className="glass-ai overflow-hidden rounded-2xl">
      {/* Header */}
      <div className="flex items-start justify-between gap-3 border-b border-[oklch(0.55_0.20_295)]/15 px-4 py-3" style={{ backgroundColor: "color-mix(in oklab, var(--color-ai) 6%, transparent)" }}>
